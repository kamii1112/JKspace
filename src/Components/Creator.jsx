        ...
        <div className="">
            {
                ...
                (<div className="p-30 flex justify-center items-center w-[100vw] h-[100vh]">
                    ...
                    :
                    <div className="w-full h-[100vh] p-28 flex flex-row justify-evenly">
                        <div className="flex flex-col justify-center w-[50%]">
                            <h1 className="text-xl font-semibold">Welcome to Creator Login!</h1>
                            ...
                            <h1 className="text-3xl mt-4 font-bold text-[#a7adfe]">Ready to Get Started?</h1>
                            <h1 className="text-xl mt-5">Login now and start exploring all the possiblities as creator!</h1>
                        </div >
                        <div className="flex flex-col items-center my-auto px-5 shadow-xl w-[30%] rounded-xl py-20">
                            <div>
                            ...
                            <button onClick={submitHandler}
                                className="border py-2 px-10 rounded-md hover:bg-[#a7adfe] hover:text-white transition-all duration-300"
                            >Submit</button>
                        </div>
                    </div >
            }
